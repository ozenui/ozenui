...
<li class="relative flex flex-shrink-0 flex-grow-0 items-start justify-start self-stretch">
...
<li class="relative flex flex-shrink-0 flex-grow-0 items-start justify-start self-stretch pl-6">
