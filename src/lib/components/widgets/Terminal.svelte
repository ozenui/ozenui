...
<main
	class="flex h-full w-full flex-col items-start justify-start gap-5 overflow-hidden rounded-[10px] border border-white/10 bg-white/5 p-2 text-left text-[13px] transition-all duration-300 ease-out"
>
	<li class="relative flex flex-shrink-0 flex-grow-0 items-start justify-start gap-2 self-stretch">
